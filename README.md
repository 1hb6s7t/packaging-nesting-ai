...
- AI 工具接口：`GET /api/ai/tools`、`POST /api/ai/chat`、`POST /api/ai/tools/execute`，兼容 `POST /api/ai/tools/search-orders|run-solver|validate-solution|compare-solutions|explain-unplaced-items|generate-report|export-pdf|export-dxf`
