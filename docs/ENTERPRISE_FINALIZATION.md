...
- `docs/AI_BATCH_TOOLS.md` is the operator-facing playbook for those batch tools, including permissions, example payloads, failure handling, approval/export handoff, and operation-log checks.
